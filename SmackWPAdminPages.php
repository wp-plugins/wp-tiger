...
/*
        ...
        require_once(WP_PLUGIN_DIR . "/" . basename(dirname(__FILE__)) . "/widget-fields.php");
        require_once(WP_PLUGIN_DIR . "/" . basename(dirname(__FILE__)) . "/forms.php");
        require_once(WP_PLUGIN_DIR . "/" . basename(dirname(__FILE__)) . "/pro-features.php");
*/
